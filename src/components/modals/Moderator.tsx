...
const Moderator: React.FC<Modal> = ({ setModeratorModal }) => {
  ...
  const onSubmit = () => {
    ...
    toast.success(() => (
      <div className="font-(family-name:--font-jersey-25)">Sala Creada</div>
    ));
  };
    ...
    <div className="flex w-screen min-h-screen bg-background/60 justify-center items-center fixed inset-0">
      <div className="flex flex-col bg-white p-6 rounded-2xl w-full max-w-md md:max-w-lg lg:max-w-xl">
        <div className="flex justify-center items-center gap-4">
          <img src={dragon} alt="Narwhal" className="w-20 flex-initial" />
        ...
        <div className="flex flex-col justify-center items-center bg-white p-6 rounded-2xl w-full">
          <div className="font-(family-name:--font-jersey-25) text-xl">
          ...
          <div className="flex flex-col">
            ...
            <input
              className="font-(family-name:--font-jersey-25) border p-1 rounded-sm w-40 text-center"
              type="text"
              value={codigo}
              readOnly
            />
            ...
            <button
              className="font-(family-name:--font-jersey-25) bg-btn-primary text-amber-50 rounded-sm m-2 w-2/3"
              onClick={() => onSubmit()}
            >
              Crear sala
            </button>
